...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { address: @information.address, district: @information.district, infection: @information.infection, info: @information.info, name: @information.name, news: @information.news, province: @information.province, publication: @information.publication, status: @information.status, yob: @information.yob } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { address: @information.address, district: @information.district, infection: @information.infection, info: @information.info, name: @information.name, news: @information.news, province: @information.province, publication: @information.publication, status: @information.status, yob: @information.yob } }
